...
class Plugin implements JsonSerializable
{
    ...
    {
        return $this->category === PluginFactory::get_categories()[PluginFactory::CATEGORY_BUNDLES] ? __('Buy bundle →', 'octolize-royal-mail-shipping') : __('Buy plugin →', 'octolize-royal-mail-shipping');
    }
}
