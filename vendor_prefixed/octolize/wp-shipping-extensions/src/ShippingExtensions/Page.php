...
namespace OctolizeShippingRoyalMailVendor\Octolize\ShippingExtensions;

use OctolizeShippingRoyalMailVendor\Octolize\ShippingExtensions\Plugin\Plugin;
use OctolizeShippingRoyalMailVendor\Octolize\ShippingExtensions\Plugin\PluginFactory;
use OctolizeShippingRoyalMailVendor\Octolize\ShippingExtensions\Plugin\PluginSorter;
use OctolizeShippingRoyalMailVendor\Octolize\ShippingExtensions\Tracker\ViewPageTracker;
...
class Page implements Hookable
{
    ...
    {
        add_submenu_page(self::PARENT_SLUG, _x('Shipping Extensions', 'Page title', 'octolize-royal-mail-shipping'), $this->get_menu_title(), 'manage_options', self::MENU_SLUG, [$this, 'render_page']);
    }
    /**
     * @return void
     */
    ...
    {
        $menu_title = nl2br(_x("Shipping\nExtensions", 'Menu Title', 'octolize-royal-mail-shipping'));
