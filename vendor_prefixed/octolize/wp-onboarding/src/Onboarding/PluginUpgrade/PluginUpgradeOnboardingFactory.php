...
namespace OctolizeShippingRoyalMailVendor\Octolize\Onboarding\PluginUpgrade;

use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\Field\Html;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\Onboarding;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\OnboardingButton;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\OnboardingOption;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\OnboardingShouldShowAlwaysStrategy;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\OnboardingShouldShowStrategy;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\OnboardingStep;
use OctolizeShippingRoyalMailVendor\Octolize\Onboarding\OnboardingTrackerData;
use OctolizeShippingRoyalMailVendor\WPDesk\Forms\Field;
/**
...
class PluginUpgradeOnboardingFactory
{
    ...
    private function prepare_steps(string $previous_version, string $current_version): array
    {
        ...
        $onboarding_step->set_show(\true)->set_heading(sprintf(__('Thank you for updating %1$s!', 'octolize-royal-mail-shipping'), $this->plugin_name))->set_sub_heading(__('It is really important to keep the plugins up to date. We have implemented some improvements and new functionalities. Find out what has changed:', 'octolize-royal-mail-shipping'));
    ...
    {
        return [(new OnboardingButton())->set_label(__('I\'m not interested', 'octolize-royal-mail-shipping'))->set_classes(OnboardingButton::BTN_LINK), (new OnboardingButton())->set_label(__('Thanks for letting me know', 'octolize-royal-mail-shipping'))->set_type(OnboardingButton::TYPE_CLOSE)];
    }
