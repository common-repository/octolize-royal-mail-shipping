...
namespace OctolizeShippingRoyalMailVendor\Octolize\Tracker;

use OctolizeShippingRoyalMailVendor\Octolize\Tracker\DeactivationTracker\OctolizeReasonsFactory;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\OptInNotice;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplay;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAlways;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplayAndConditions;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterPresent;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplayGetParameterValue;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplayOrConditions;
use OctolizeShippingRoyalMailVendor\Octolize\Tracker\OptInNotice\ShouldDisplayShippingMethodInstanceSettings;
...
use OctolizeShippingRoyalMailVendor\WPDesk\Tracker\Deactivation\PluginData;
use OctolizeShippingRoyalMailVendor\WPDesk\Tracker\Deactivation\ReasonsFactory;
use OctolizeShippingRoyalMailVendor\WPDesk\Tracker\Deactivation\TrackerFactory;
use OctolizeShippingRoyalMailVendor\WPDesk\Tracker\PluginActionLinks;
/**
...
class TrackerInitializer implements HookableCollection
{
    ...
    public function hooks()
    {
        ...
        $tracker_consent = new \OctolizeShippingRoyalMailVendor\WPDesk_Tracker_Persistence_Consent();
     ...
     */
    public static function create_from_plugin_info(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info, $should_display, ReasonsFactory $reasons_factory = null)
    {
     ...
     * @return TrackerInitializer
     */
    public static function create_from_plugin_info_for_shipping_method(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info, string $shipping_method_id, ReasonsFactory $reasons_factory = null)
    {
        $shops = $plugin_info->get_plugin_shops();
        $shop_url = $shops[get_locale()] ?? $shops['default'] ?? 'https://octolize.com';
