...
class SenderToOctolize implements \WPDesk_Tracker_Sender
{
    ...
    {
        \OctolizeShippingRoyalMailVendor\WPDesk_Logger_Factory::log_message("Target URL: " . $this->get_api_url(), 'octolize-sender', \OctolizeShippingRoyalMailVendor\WPDesk_Logger::DEBUG);
        ...
        if ($response instanceof \WP_Error) {
            throw new \OctolizeShippingRoyalMailVendor\WPDesk_Tracker_Sender_Exception_WpError('Payload send error', $response);
        } else {
            return $response;
        }
    }
