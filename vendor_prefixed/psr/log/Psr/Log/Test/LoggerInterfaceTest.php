...
namespace OctolizeShippingRoyalMailVendor\Psr\Log\Test;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('OctolizeShippingRoyalMailVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('OctolizeShippingRoyalMailVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('OctolizeShippingRoyalMailVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
