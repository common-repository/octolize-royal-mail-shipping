...
use OctolizeShippingRoyalMailVendor\Monolog\Formatter\JsonFormatter;
use OctolizeShippingRoyalMailVendor\PhpAmqpLib\Message\AMQPMessage;
use OctolizeShippingRoyalMailVendor\PhpAmqpLib\Channel\AMQPChannel;
use AMQPExchange;
/**
