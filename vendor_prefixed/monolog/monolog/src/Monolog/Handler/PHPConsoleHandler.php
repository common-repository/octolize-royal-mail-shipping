...
use OctolizeShippingRoyalMailVendor\Monolog\Formatter\LineFormatter;
...
use OctolizeShippingRoyalMailVendor\Monolog\Utils;
use OctolizeShippingRoyalMailVendor\PhpConsole\Connector;
use OctolizeShippingRoyalMailVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use OctolizeShippingRoyalMailVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!class_exists('OctolizeShippingRoyalMailVendor\PhpConsole\Connector')) {
