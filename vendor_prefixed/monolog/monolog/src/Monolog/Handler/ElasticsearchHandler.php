...
use OctolizeShippingRoyalMailVendor\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
...
use OctolizeShippingRoyalMailVendor\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use OctolizeShippingRoyalMailVendor\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use OctolizeShippingRoyalMailVendor\Elasticsearch\Client;
use OctolizeShippingRoyalMailVendor\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use OctolizeShippingRoyalMailVendor\Elastic\Elasticsearch\Client as Client8;
/**
