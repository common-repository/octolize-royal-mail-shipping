...
class RedisHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!($redis instanceof \OctolizeShippingRoyalMailVendor\Predis\Client || $redis instanceof \Redis)) {
    ...
    protected function writeCapped(array $record): void
    {
        if ($this->redisClient instanceof \Redis) {
            $mode = defined('OctolizeShippingRoyalMailVendor\Redis::MULTI') ? \Redis::MULTI : 1;
