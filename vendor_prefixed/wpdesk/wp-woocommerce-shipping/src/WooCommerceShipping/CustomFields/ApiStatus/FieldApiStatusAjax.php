 ...
 */
namespace OctolizeShippingRoyalMailVendor\WPDesk\WooCommerceShipping\CustomFields\ApiStatus;
...
class FieldApiStatusAjax implements Hookable
{
    ...
    public function handle_api_status_ajax_request($return = \false)
    {
        ...
        $json_response = array('connected' => \true, 'status' => __('OK', 'octolize-royal-mail-shipping'), 'class_name' => 'wpdesk_wc_shipping_api_status_ok');
