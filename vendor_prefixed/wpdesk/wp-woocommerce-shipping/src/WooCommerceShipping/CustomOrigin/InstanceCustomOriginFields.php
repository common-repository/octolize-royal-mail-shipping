...
class InstanceCustomOriginFields extends CustomOriginFields
{
    ...
    {
        return __('Origin Settings for this Shipping Method', 'octolize-royal-mail-shipping');
    }
    /**
     * @return string
     */
    ...
    {
        return __('Enable custom origin for this shipping method', 'octolize-royal-mail-shipping');
    }
    /**
     * @return string
     */
    ...
    {
        return __('Use this option to use a different shipper\'s address for this shipping method.', 'octolize-royal-mail-shipping');
    }
}
