...
if (!\class_exists('OctolizeShippingRoyalMailVendor\Basic_Requirement_Checker')) {
    require_once __DIR__ . '/Basic_Requirement_Checker.php';
}
if (!\class_exists('OctolizeShippingRoyalMailVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
