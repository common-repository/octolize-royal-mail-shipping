...
if (!\interface_exists('OctolizeShippingRoyalMailVendor\WPDesk_Requirement_Checker')) {
    require_once __DIR__ . '/Requirement_Checker.php';
}
if (!\class_exists('OctolizeShippingRoyalMailVendor\WPDesk_Basic_Requirement_Checker')) {
    /**
    ...
    class WPDesk_Basic_Requirement_Checker implements WPDesk_Requirement_Checker
    {
        ...
        private static function retrieve_plugins_data_in_transient($use_transients = \true)
        {
            ...
            if ($plugins === \false) {
                ...
                if (!\function_exists('get_plugins') && !\function_exists('OctolizeShippingRoyalMailVendor\get_plugins')) {
