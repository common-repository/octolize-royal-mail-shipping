...
?>" style="display:none;">
	<h2><?php 
echo \sprintf(\__('You are deactivating %s plugin.', 'octolize-royal-mail-shipping'), $plugin_title);
?></h2>
...
?>">
		<div class="body">
			<div class="panel active" data-panel-id="reasons">
				<p><?php 
\_e('Before you proceed, please take 30 seconds to let us know what brought you to this decision. Your answers are anonymous.', 'octolize-royal-mail-shipping');
?></p>
...
\_e('Skip &amp; Deactivate', 'octolize-royal-mail-shipping');
?></a>
                </div>
...
?>><?php 
\_e('Submit &amp; Deactivate', 'octolize-royal-mail-shipping');
?></button>
                    <button href="#" class="button button-secondary button-close tracker-button-close"><?php 
\_e('Cancel', 'octolize-royal-mail-shipping');
?></button>
                </div>
