...
use LogicException;
use OctolizeShippingRoyalMailVendor\Monolog\Handler\NullHandler;
use OctolizeShippingRoyalMailVendor\Monolog\Logger;
use OctolizeShippingRoyalMailVendor\Monolog\Registry;
use OctolizeShippingRoyalMailVendor\Monolog\Handler\StreamHandler;
use OctolizeShippingRoyalMailVendor\Psr\Log\LogLevel;
use OctolizeShippingRoyalMailVendor\WPDesk\Logger\WC\WooCommerceCapture;
use OctolizeShippingRoyalMailVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('OctolizeShippingRoyalMailVendor\WC_LOG_THRESHOLD')) {
            define('OctolizeShippingRoyalMailVendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
