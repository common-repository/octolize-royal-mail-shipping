...
namespace OctolizeShippingRoyalMailVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'octolize-royal-mail-shipping'),
            $dir
        ), \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'octolize-royal-mail-shipping'),
            $file
        ), \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
