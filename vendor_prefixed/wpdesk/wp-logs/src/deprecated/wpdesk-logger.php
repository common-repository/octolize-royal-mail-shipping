...
if (!\class_exists('OctolizeShippingRoyalMailVendor\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \OctolizeShippingRoyalMailVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'octolize-royal-mail-shipping'), 'emergency' => \__('Emergency', 'octolize-royal-mail-shipping'), 'alert' => \__('Alert', 'octolize-royal-mail-shipping'), 'critical' => \__('Critical', 'octolize-royal-mail-shipping'), 'error' => \__('Error', 'octolize-royal-mail-shipping'), 'warning' => \__('Warning', 'octolize-royal-mail-shipping'), 'notice' => \__('Notice', 'octolize-royal-mail-shipping'), 'info' => \__('Info', 'octolize-royal-mail-shipping'), 'debug' => \__('Debug', 'octolize-royal-mail-shipping')];
        }
        /**
         * @param string $level
         * @param string $source
