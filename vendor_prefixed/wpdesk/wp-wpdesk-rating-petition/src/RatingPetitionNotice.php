 ...
 */
namespace OctolizeShippingRoyalMailVendor\WPDesk\RepositoryRating;
...
class RatingPetitionNotice implements Hookable
{
    ...
    {
        new \OctolizeShippingRoyalMailVendor\WPDesk\Notice\PermanentDismissibleNotice($this->get_notice_content(), $notice_name, \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO);
    }
    /**
     * Get notice content.
     *
    ...
    private function get_notice_content()
    {
        ...
        $content = sprintf(__('Awesome, you\'ve been using %s for more than 2 weeks. Could you please do me a BIG favor and give it a 5-star rating on WordPress? ~ Peter', 'octolize-royal-mail-shipping'), $this->plugin_name);
        $content .= '<br/>';
