...
?>">
			<?php 
\esc_html_e('Set image', 'octolize-royal-mail-shipping');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'octolize-royal-mail-shipping');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'octolize-royal-mail-shipping');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'octolize-royal-mail-shipping');
?>"
				},
				library: {
					type: ['image']
