...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \OctolizeShippingRoyalMailVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Factory::notice($noticeContent, \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_wp_notice_info')) {
    /**
     * Creates Notice Info.
     *
...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Factory::notice($noticeContent, \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Factory::notice($noticeContent, \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Factory::notice($noticeContent, \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_wp_notice_success')) {
    /**
     * Creates Notice Success.
     *
...
if (!\function_exists('OctolizeShippingRoyalMailVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \OctolizeShippingRoyalMailVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('OctolizeShippingRoyalMailVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
