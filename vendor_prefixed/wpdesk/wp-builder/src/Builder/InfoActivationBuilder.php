...
namespace OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Builder;
...
use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
...
class InfoActivationBuilder extends AbstractBuilder
{
     ...
     */
    public function __construct(\OctolizeShippingRoyalMailVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
