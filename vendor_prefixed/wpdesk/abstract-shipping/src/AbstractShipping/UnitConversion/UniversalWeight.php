 ...
 */
namespace OctolizeShippingRoyalMailVendor\WPDesk\AbstractShipping\UnitConversion;
...
class UniversalWeight
{
    ...
    public function as_unit_rounded($target_unit, $precision = 2)
    {
        ...
        switch ($target_unit) {
            ...
            default:
                throw new UnitConversionException(__('Can\'t convert weight to target unit.', 'octolize-royal-mail-shipping'));
        }
    }
}
