...
namespace OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow;

use OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory;
/**
...
{
    const LIBRARY_TEXT_DOMAIN = 'octolize-royal-mail-shipping';
     ...
     */
    private function init_translations(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \OctolizeShippingRoyalMailVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info();
