...
namespace OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization\Simple;

use OctolizeShippingRoyalMailVendor\WPDesk\Helper\HelperRemover;
use OctolizeShippingRoyalMailVendor\WPDesk\Helper\PrefixedHelperAsLibrary;
use OctolizeShippingRoyalMailVendor\WPDesk\License\PluginRegistrator;
use OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization\ActivationTrait;
use OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization\BuilderTrait;
use OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization\PluginDisablerByFileTrait;
use OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization\InitializationStrategy;
use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
/**
...
class SimplePaidStrategy implements InitializationStrategy
{
    ...
    /** @var SlimPlugin */
    private $plugin;
    public function __construct(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_before_init(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    public function run_init(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info)
    {
        if (!$this->plugin) {
            $this->plugin = $this->build_plugin($plugin_info);
        }
