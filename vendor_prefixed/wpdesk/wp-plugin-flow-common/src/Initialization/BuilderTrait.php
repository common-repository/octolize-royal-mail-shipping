...
namespace OctolizeShippingRoyalMailVendor\WPDesk\Plugin\Flow\Initialization;

use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Plugin\Activateable;
use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Plugin\Deactivateable;
use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Plugin\SlimPlugin;
use OctolizeShippingRoyalMailVendor\WPDesk\PluginBuilder\Storage\StorageFactory;
/**
...
trait BuilderTrait
{
     ...
     * @return SlimPlugin
     */
    private function build_plugin(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info)
    {
     ...
     * @return SlimPlugin
     */
    private function init_register_hooks(\OctolizeShippingRoyalMailVendor\WPDesk_Plugin_Info $plugin_info, SlimPlugin $plugin)
    {
