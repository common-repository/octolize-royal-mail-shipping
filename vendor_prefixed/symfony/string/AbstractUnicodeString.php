 ...
 */
namespace OctolizeShippingRoyalMailVendor\Symfony\Component\String;

use OctolizeShippingRoyalMailVendor\Symfony\Component\String\Exception\ExceptionInterface;
use OctolizeShippingRoyalMailVendor\Symfony\Component\String\Exception\InvalidArgumentException;
use OctolizeShippingRoyalMailVendor\Symfony\Component\String\Exception\RuntimeException;
/**
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    {
        $str = clone $this;
        if (!$compat || \PHP_VERSION_ID < 70300 || !\defined('OctolizeShippingRoyalMailVendor\Normalizer::NFKC_CF')) {
