 ...
 */
namespace OctolizeShippingRoyalMailVendor\Symfony\Contracts\Service;
...
trait ServiceSubscriberTrait
{
    ...
    public static function getSubscribedServices(): array
    {
        ...
        $services = \is_callable(['OctolizeShippingRoyalMailVendor\parent', __FUNCTION__]) ? parent::getSubscribedServices() : [];
    ...
    public function setContainer(ContainerInterface $container)
    {
        ...
        if (\is_callable(['OctolizeShippingRoyalMailVendor\parent', __FUNCTION__])) {
