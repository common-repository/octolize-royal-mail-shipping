 ...
 */
namespace OctolizeShippingRoyalMailVendor\Symfony\Polyfill\Intl\Normalizer;
    ...
    public static function normalize(string $s, int $form = self::FORM_C)
    {
        ...
        switch ($form) {
            ...
            case self::NFKD:
                ...
                break;
            default:
                if (\defined('OctolizeShippingRoyalMailVendor\Normalizer::NONE') && \Normalizer::NONE == $form) {
                    return $s;
                }
